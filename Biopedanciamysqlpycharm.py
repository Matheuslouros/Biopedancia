...
cursor.execute("""
    ...
    ( nome, peso, estatura, massaMuscular, bracoES,bracoDI,antibracoES,antibracoDI,torax,abdominal,quadril,cintura,
     coxaES, coxaDI,panturilhaES,panturilhaDI, imc)
    VALUES (%s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s,%s,%s);
""", (nome, peso, estatura, imc, bracoES, bracoDI, antibracoES, antibracoDI, torax, abdominal, quadril, cintura,
      coxaES,coxaDI, panturilhaES, panturilhaDI, imc))
